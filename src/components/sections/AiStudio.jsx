            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${feature.gradient} bg-opacity-20 border border-violet-500/30 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-3 px-8 py-4 rounded-lg bg-gradient-to-r from-teal-500 via-emerald-500 to-teal-600   text-white font-semibold shadow-lg  group-hover:opacity-100 transition-all duration-300 hover:scale-105"
              >
